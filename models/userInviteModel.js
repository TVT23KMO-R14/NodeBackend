...
/*const sql = {
  ...
  ADD_INVITE: 'INSERT INTO "groupInvite" ("group_idGroup", "inviteText", "inviteUserId", "groupMember_idGroupMember VALUES ($1, $2, $3, (SELECT "groupMember_idGroupMember" FROM "groupMember" WHERE "role"=\'admin\' AND "group_idGroup"=$1))',
  GET_INVITES_BY_GROUP_ADMIN: 'INSERT INTO "groupInvite" ("group_idGroup", "inviteText", "inviteUserId", "groupMember_idGroupMember") VALUES ($1, $2, $3, (SELECT "groupMember_idGroupMember" FROM "groupMember" WHERE "role"=\'admin\' AND "group_idGroup"=$1))'
} */
